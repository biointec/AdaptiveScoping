...
for (change in tp.change) {
  set.seed(1)
  for (scoping in c(3)){ #use the desired scoping rate * 10 --> scoping of 3 == SR=0.3
  ...
  filename <- file.path(save.dir, paste("Fixed_Scoping 0.", scoping ,"_qtl200_",n.iterations,"rep_", change,"_",date, ".RData", sep = "") )                      
